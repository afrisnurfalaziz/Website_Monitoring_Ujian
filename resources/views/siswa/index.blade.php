                        ...
                        {{-- <tbody> --}}
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('siswa.destroy', $data)}}" 
                            ...
                            {{-- Modal Edit Siswa --}}
                            <div class="modal fade" id="editDataSiswa{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        ...
                                        <form action="{{ url('siswa/'. $data->id ) }}" method="POST">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    id="exampleInputNoInduk" placeholder="Nomer Induk" name="nomer_induk"
                                                    value="{{$data->nomer_induk ?? old('nomer_induk')}}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    id="exampleInputSiswa" placeholder="Nama Siswa" name="nama_siswa"
                                                    value="{{$data->nama_siswa ?? old('nama_siswa')}}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    id="exampleInputJenisKelamin" placeholder="Masukkan Jenis Kelamin" name="jenis_kelamin"
                                                    value="{{$data->jenis_kelamin ?? old('jenis_kelamin')}}">
